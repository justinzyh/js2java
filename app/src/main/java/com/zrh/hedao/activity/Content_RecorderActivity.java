...
public class Content_RecorderActivity extends BasicActivity {

    private JsInterface JSInterface2 = new JsInterface();
    private Context  context;
    private Activity activity;
    private String url = "file:///android_asset/html/content_record.html";
    private WebView webView;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_content__recorder);
        context = this;
        activity = this;
        initView();
    }
    ...
    private void initView() {
        webView = (WebView) findViewById(R.id.content_record_web);
        initWebView();
    }
    ...
    private void initWebView() {
        ...
        webView.setWebViewClient(new RecorderWebViewClient());
    ...
    class RecorderWebViewClient extends WebViewClient {
        @Override
