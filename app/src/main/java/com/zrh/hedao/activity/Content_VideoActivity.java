...
public class Content_VideoActivity extends BasicActivity {

    private JsInterface JSInterface2 = new JsInterface();
    private Context  context;
    private Activity activity;
    private String url = "file:///android_asset/html/content_video.html";
    ...
    private void initView() {
        webView = (WebView) findViewById(R.id.content_video_web);
        initWebView();
    }
