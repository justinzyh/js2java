...
public class Content_CameraActivity extends BasicActivity {

    private WebView webView;
    private JsInterface JSInterface2 = new JsInterface();
    private Context  context;
    private Activity activity;
    private String url = "file:///android_asset/html/content_camera.html";
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_content__camera);
        context = this;
        activity = this;
        initView();
    }
    ...
    private void initView() {
        webView = (WebView) findViewById(R.id.content_camera_web);
        initWebView();
    }
    ...
    private void initWebView() {
        ...
        webView.setWebViewClient(new CameraWebViewClient());
