...
require(["dojo/_base/declare", "esri/layers/TiledMapServiceLayer"],
    function (declare, TiledMapServiceLayer) {
        declare("TDTTiledMapLayer", [TiledMapServiceLayer], {
...
require(["dojo/_base/declare", "esri/layers/TiledMapServiceLayer"],
    function (declare, TiledMapServiceLayer) {
        declare("TDTTiledAnnoLayer", [TiledMapServiceLayer], {
            constructor: function () {
                this.spatialReference = new esri.SpatialReference({wkid: 4326});
                this.initialExtent = (this.fullExtent = new esri.geometry.Extent(-180.0, -90.0, 180.0, 90.0, this.spatialReference));
            ...
            err: function (err) {
                console.log("Failed to load TDTAnnoLayer due to an error: ", err);
            }
        });
    });
//天地图卫星图
require(["dojo/_base/declare", "esri/layers/TiledMapServiceLayer"],
    function (declare, TiledMapServiceLayer) {
        declare("TDTTiledImageryLayer", [TiledMapServiceLayer], {
            constructor: function () {
                this.spatialReference = new esri.SpatialReference({wkid: 4326});
                this.initialExtent = (this.fullExtent = new esri.geometry.Extent(-180.0, -90.0, 180.0, 90.0, this.spatialReference));
